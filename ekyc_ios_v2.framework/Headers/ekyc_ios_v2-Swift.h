...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ekyc_ios_v2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11ekyc_ios_v218BaseViewController")
...
SWIFT_CLASS("_TtC11ekyc_ios_v229BioRegistrationViewController")
@interface BioRegistrationViewController : BaseViewController <FaceCaptureControllerDelegate>
...
SWIFT_CLASS("_TtC11ekyc_ios_v229BioVerificationViewController")
@interface BioVerificationViewController : BaseViewController <FaceCaptureControllerDelegate>
- (void)viewDidAppear:(BOOL)animated;
- (void)viewDidLoad;
- (void)faceCapture:(FaceCaptureController * _Nonnull)controller didCapture:(FaceCaptureImage * _Nonnull)faceCaptureImage;
- (void)faceCaptureDidFailed:(FaceCaptureController * _Nonnull)controller;
...
SWIFT_CLASS("_TtC11ekyc_ios_v231PhotoConfirmationViewController") SWIFT_AVAILABILITY(ios,introduced=13.0)
@interface PhotoConfirmationViewController : BaseViewController
